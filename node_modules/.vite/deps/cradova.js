// node_modules/cradova/dist/index.js
var Screen = class {
  ...
  deActivate() {
    var _a;
    (_a = this.template.parentElement) == null ? void 0 : _a.removeChild(this.template);
  }
  async Activate(data, force) {
    ...
    if (this.transition) {
      (_a = this.template) == null ? void 0 : _a.classList.add("CRADOVA-UI-" + this.transition);
    }
    if (this.callBack) {
...
function swipe(callback, touching = false, element) {
  ...
  return {
    start() {
      if (touching) {
        escapeTSError == null ? void 0 : escapeTSError.addEventListener("touchmove", handleGesture);
      } else {
        escapeTSError == null ? void 0 : escapeTSError.addEventListener("touchstart", handleTouchStart);
        escapeTSError == null ? void 0 : escapeTSError.addEventListener("touchend", handleGesture);
      }
    },
    stop() {
      if (touching) {
        escapeTSError == null ? void 0 : escapeTSError.removeEventListener("touchmove", handleGesture);
      } else {
        escapeTSError == null ? void 0 : escapeTSError.removeEventListener("touchstart", handleTouchStart);
        escapeTSError == null ? void 0 : escapeTSError.removeEventListener("touchend", handleGesture);
      }
    }
  };
}
...
var _ = (...element_initials) => {
  ...
  if (Object.prototype.toString.call(element_initials[1]) === "[object Object]") {
    ...
    if (firstProps == null ? void 0 : firstProps.beforeMount) {
...
//# sourceMappingURL=cradova.js.map
